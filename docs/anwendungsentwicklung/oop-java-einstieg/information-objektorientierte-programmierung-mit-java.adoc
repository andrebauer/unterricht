...
In Java muss jede Klasse mit dem Zugriffsmodifikator `public`
in einer Datei mit dem Namen der Klasse gespeichert werden, so dass das
Programm nun aus drei Dateien besteht.
