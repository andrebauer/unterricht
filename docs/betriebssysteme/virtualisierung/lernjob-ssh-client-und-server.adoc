...
verwendet werden und die Namen der Pakete können abweichen.
...
----
$ sudo -i <1>
# apt install openssh-server <2>
----
<1> Anmelden als Super-User (root).
<2> Installation und Start des SSH-Servers.
