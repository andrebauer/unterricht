...
Nähere Informationen, wie man ein AsciiDoc-Dokument gestalten kann,
stehen im
...
mit PlantUML hinzu und lassen
Asciidoctor daraus ein HTML-Dokument mit SVG-Grafik erstellen.
...
PDF-Dokumente werden aus Asciidoc-Dokumenten durch Angabe der Erweiterung
