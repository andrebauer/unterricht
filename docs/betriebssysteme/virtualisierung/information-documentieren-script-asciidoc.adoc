...
=== Diagramme mit Asciidcotor erstellen

[source,sh]
----
$ sudo gem install asciidoctor asciidcotor-diagram <1>
$ sudo apt update
$ sudo apt install plantuml
$ mkdir srv
$ cd srv
$ nano index.adoc
$ asciidcotor -r asciidoctor-diagram -b html index.adoc <2>
----
<1> Installation von Asciidoctor und Asciidcotor Diagramm mit RubyGems.
